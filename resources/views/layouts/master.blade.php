    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a class="brand-link text-decoration-none">
                ...
                <span class="brand-text font-weight-light">R&T Admin</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/barang') }}" class="nav-link {{ $tour ?? '' }}">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2022 <a href="#">GCA</a>.</strong>
            All rights reserved.
